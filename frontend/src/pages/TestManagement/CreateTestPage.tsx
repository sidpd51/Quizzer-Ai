const CreateTestPage = () => {
  return (
    <div className="w-full flex flex-col">
      ...
      <div className="mt-5 w-full bg-white flex flex-col p-5 rounded-xl">
        {/* subject name */}
        <label className="text-2xl text-gray-800">Add Subject Name</label>
        <input
          type="text"
        ...
        {/* test-details */}
        <label className="text-2xl text-gray-800">Add Test Details</label>
        <textarea
          rows={15}
        ...
        {/* tags */}
        <label className="text-2xl text-gray-800">Add Tags/Keywords</label>
        <input
          type="text"
